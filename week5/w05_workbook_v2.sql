...
-- ------------------------------------------------------------------------
-- 2b. Write a query to retrieve the actor ID, first name, and last name
-- for actors whose last name starts with 'M' and ends with 'S'.
-- ------------------------------------------------------------------------
SELECT a.actor_id AS 'Actor Id'
,      a.first_name AS 'First Name'
,      a.last_name AS 'Last Name'
FROM   actor a
WHERE  a.last_name LIKE 'M%S';

-- ------------------------------------------------------------------------
-- 2c. Write a query to retrieve the actor ID, first name, and last name
-- for actors whose last name is NOT 'WILLIAMS' or 'DAVIS'.
-- ------------------------------------------------------------------------
SELECT a.actor_id AS 'Actor Id'
,      a.first_name AS 'First Name'
,      a.last_name AS 'Last Name'
FROM   actor a
WHERE  a.last_name NOT IN ('WILLIAMS', 'DAVIS');

-- ------------------------------------------------------------------------
-- REFLECTION: Why might using '=' instead of 'IN' in the query above not work?
-- ------------------------------------------------------------------------
-- Your answer:
-- ------------------------------------------------------------------------
SELECT a.actor_id AS 'Actor Id'
...
-- ------------------------------------------------------------------------
-- CHALLENGE SECTION: APPLYING YOUR KNOWLEDGE
-- ------------------------------------------------------------------------

-- 11. You are preparing a customer list for a promotional mailer.
-- Write a query to find all customers who do NOT have an email address.
-- ------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------
-- 12. Debug this query. It is intended to return all customers in Canada,
-- but it returns no rows. Identify and fix the issue.
-- ------------------------------------------------------------------------
-- SELECT * FROM customer c
-- JOIN address a ON c.address_id = a.address_id
-- JOIN city ci ON a.city_id = ci.city_id
-- WHERE ci.city = 'Canada';
--    Example Output:
--    +-------------+------------+-----------+-------------------+
--    | Customer ID | First Name | Last Name | Country           |
--    +-------------+------------+-----------+-------------------+
--    |         110 | ANDRE      | WRIGHT    | Canada            |
--    |         273 | CARRIE     | JONES     | Canada            |
--    +-------------+------------+-----------+-------------------+
...
-- ------------------------------------------------------------------------
-- 13. Rewrite this query using IN instead of multiple OR conditions.
-- ------------------------------------------------------------------------
-- SELECT * FROM actor
-- WHERE last_name = 'SMITH' OR last_name = 'JONES' OR last_name = 'LEE';
--    Example Output:
--    +----------+------------+-----------+
--    | Actor ID | First Name | Last Name |
--    +----------+------------+-----------+
...
-- ------------------------------------------------------------------------
-- 14. Explain in your own words: Why does this query return no results?
-- ------------------------------------------------------------------------
-- SELECT * FROM customer
-- WHERE email = NULL;
--    Example Output:
--    N/A – This returns 0 rows because the comparison is invalid.
...
-- ------------------------------------------------------------------------
-- 15. Business case: A manager wants to see a list of films that are
-- either rated 'PG' or 'PG-13' and have a rental duration longer than 5 days.
-- Write the query to support this.
-- ------------------------------------------------------------------------
-- Expected columns: film_id, title, rating, rental_duration
-- ------------------------------------------------------------------------
--    Example Output:
--    +---------+-------------------------+--------+------------------+
--    | Film ID | Title                   | Rating | Rental Duration  |
--    +---------+-------------------------+--------+------------------+
--    |     234 | HURRICANE AFFAIR        | PG     |                6 |
--    |     145 | MONSOON CAUSE           | PG-13  |                7 |
--    |      98 | THIRTEEN LUCK           | PG     |                6 |
--    +---------+-------------------------+--------+------------------+
